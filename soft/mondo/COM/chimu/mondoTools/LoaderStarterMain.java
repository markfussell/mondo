...
<PRE>
Usage: java LoaderStarterMain <loaderName> <startingClassName> ...
</PRE>
**/
public class LoaderStarterMain {
    public static void main(String args[]) {
        new LoaderStarterMain().executeWithArgs(args);
    }

    public void executeWithArgs(String args[]) {
        if (args.length < 2) {
            System.out.println("Usage: java LoaderStarterMain <loaderName> <startingClassName> ...");
            return;
        }
    ...
    protected void callMainIn_usingLoader_args(
